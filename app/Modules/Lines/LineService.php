...
class LineService
{
    ...
    public function __construct(){
        $httpClient = new CurlHTTPClient(config('line.message.channel_access_token'));
        $this->bot = new LINEBot($httpClient, ['channelSecret' => config('line.message.channel_secret')]);
        $this->isUseLineMock = config('line.liff.login_mock_enable');
    }
